...
public class PanelJuegoDos extends JPanel implements KeyListener{
    ...
    public PanelJuegoDos(Ventana w, int puntos , int numero , int segundos, String nombre) {
        ...
        this.palabras[0] = new Palabra("Anulo");
        this.palabras[1] = new Palabra("amigo");
        this.palabras[2] = new Palabra("bonos");
        this.palabras[3] = new Palabra("Frías");
        this.palabras[4] = new Palabra("apodo");
        this.palabras[5] = new Palabra("casas");
        this.palabras[6] = new Palabra("donar");
        this.palabras[7] = new Palabra("enojo");
        this.palabras[8] = new Palabra("copas");
        this.palabras[9] = new Palabra("Cines");
        
        for(int i = 0 ; i < palabras.length ; i++ ){
            this.palabras[i].setVelocidad(15);
        }
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if((tiempo > 0) && (noTipeada < 5) && continuar){
                    ...
                    if( noTipeada >= 5 ){
                        ...
                        terminado = new Terminado(puntosJuego , "GANASTE", w, 3, nombre);
                    }
            ...
            if(entrada.equals(etiqueta)){
                    ...
                    if(this.numeroPalabra >= 9){
                        ...
                        if(noTipeada < 5){
                            ...
                            Terminado terminado = new Terminado(this.puntosJuego, "GANASTE", this.w, 3, this.nombreJugador);
                            ...
                            Timer tiempo = new Timer(1000, new ActionListener() {
                                ...
                                public void actionPerformed(ActionEvent ae) {
                                    if(contadorAlto>0){
                                        ...
                                        palabras[numeroPalabra].setVelocidad(15);
